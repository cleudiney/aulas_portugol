...
programa
{
	funcao inicio()
	{
		inteiro candidato_l = 0, candidato_b = 0
		//candidatos
		//variaveis
		...
		//informar o resultado das eleicoes 
		//parabenizar quem ganhou as eleicoes 
		//
		faca
		{
			limpa()
			...
			escolha (voto)
			{
				...
				caso 1: 
			 		candidato_l = candidato_l + 1 // Soma um voto para o candidato A
			 	pare
		...
		total_votos = candidato_l + candidato_b + brancos + nulos
		// 0 + 0 + 1 + 0
		...
		se (total_votos > 0)
		{
			porcentagem_candidato_a = (candidato_l * 100.0) / total_votos  
			...
			escreva("Candidato A: " , candidato_l, " voto(s). ", porcentagem_candidato_a, " % do total\n" )
